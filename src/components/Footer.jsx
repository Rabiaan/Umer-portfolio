    ...
    <footer className="bg-brand-black text-white py-20 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex gap-8">
          ...
          <a href="https://www.behance.net/umershabih" target="_blank" rel="noopener noreferrer" className="hover:text-brand-blue transition-colors flex items-center justify-center">
            <ion-icon name="logo-behance" style={{ fontSize: '24px' }}></ion-icon>
          </a>
        </div>
